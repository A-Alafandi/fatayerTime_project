                ...
                <div key={item.id} className="col-lg-6">
                  <div className="menu-item">
                    <div className="menu-img-container">
                      <img
                        src={item.imageUrl || `/placeholder.svg?height=80&width=80&query=${item.name}`}
                        alt={item.name}
                        className="menu-img"
                        loading="lazy"
                      />
                    ...
                    {(item.isVegetarian || item.isSpicy) && <div className="menu-badges">{renderBadges(item)}</div>}
                  </div>
                </div>
              ))}
          </div>
