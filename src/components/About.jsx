        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-6 order-2 order-lg-1 content">
            ...
            <p className="fst-italic">
              Fatayer Time is a family-run bakery specializing in authentic Middle Eastern
              pies—handmade with love and fresh ingredients every day in The Hague.
            </p>
            <ul>
              <li>
            ...
            <p>
              Our signature fatayers are baked to perfection, blending authentic Middle Eastern
              taste with quality you can trust. Every bite tells a story of tradition, passion, and
              culinary excellence.
            </p>
          </div>
        </div>
